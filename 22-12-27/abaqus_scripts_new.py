...
def control_abaqus(w, offspring, frame=None):
    for q in range(ini_pop, end_pop + 1):
        ...
        save_log('[{}][Gen{} offspring{}] Complete'.format(now_s(), w, q), frame=frame)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if os.path.isfile('./args'):
            ...
            control_abaqus(w=w, offspring=offspring, frame=frame)
