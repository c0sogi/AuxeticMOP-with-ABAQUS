...
def one_generation(w, restart, directory, p_conn, params):
    topologies, results = parent_import(w=w, restart_pop=params.restart_pop)
    ...
    print('iteration:', w)
    visualize(w=w, restart_pop=params.restart_pop, lx=params.lx, ly=params.ly, lz=params.lz,
