...
if __name__ == '__main__':
    ...
    th_abaqus = run_abaqus_script_without_gui(set_path=setPath, abaqus_script_name=abaqus_script_name, params=PARAMS,
                                              abaqus_execution_mode=abaqus_execution_mode)  # Define an abaqus thread
    th_abaqus.daemon = False
